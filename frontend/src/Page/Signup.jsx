...
const Signup = () => {
  ...
  return (
    <>
      <div className="font-[sans-serif] bg-white md:h-screen mx-20 dark:bg-black">
        <div className="grid md:grid-cols-2 items-center gap-8 h-full">
          ...
          <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto dark:bg-black">
